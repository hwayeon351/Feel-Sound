  ...
  <body style="background-color: #ffc0cb;
    ...
    <div style="
      ...
      <div
        ...
        <table class="Table" border="1"
          ...
          <tbody>
            <?php
              ...
              $u_id = $_POST['search_user'];
              $sql="SELECT * FROM HW_USER WHERE U_ID = '".$u_id."';";
              $sql_result = mysqli_query($con,$sql);
              if(!$sql_result){
                echo json_encode("THERE IS NO '$u_id' USER");
              } else{
                $tuple=array();
                $attribute=array();
        ...
        <form name="more_form" action="DetailSrcUserInfo.php" method="post">
