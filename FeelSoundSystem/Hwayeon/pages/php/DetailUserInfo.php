    ...
    <div style="
      ...
      <div
        ...
        <?php
          ...
          $find_user_sql = "SELECT U_ID FROM HW_USER";
          $user_sql_result = mysqli_query($con,$find_user_sql);
          if(!$user_sql_result){
            ...
            $UserArr=array();
            $attribute=array();
            while($attribute = mysqli_fetch_array($user_sql_result)){
              array_push($attribute, array(
                'u_id'=>$attribute[0]));
              array_push($UserArr,$attribute);
            }
          }
          $tuple_index = $_POST['tuple_num'];
          $U_ID = $UserArr[$tuple_index][0];
